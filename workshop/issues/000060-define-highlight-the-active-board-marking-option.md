...
- [ ] Style the selected span at the board prompt presentation seam using the existing palette and bracketed wording (ARCH-DRY, ARCH-PURE).
- [ ] Verify all modes, no-color, refusal, and live frame styling; run define tests and close review.
